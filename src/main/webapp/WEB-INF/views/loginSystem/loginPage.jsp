	...
	window.onload = function() {
		...
		check.onblur = function() {
			...
			if (!userValue) {
				...
				userValueinput.style.border = "2px solid red";
				setErrorFor(div1,
						"<font color='red' size='-2'>Format Wrong</font>");
				hasError = false;
				return;
			}
...
// 				hasErrorCheckEmail = false;
		...
		nextSlide.onclick = function() {
			...
			// 			hasError=true; hasErrorpwd =true; privacycheck=true;
		...
		var checkAccountStatus2 = document
				.getElementById("checkAccountStatus2");
		...
		nextSlide2.onclick = function(event) {
			...
			if (secondPageError) {
				...
				data.append('userinfo', new Blob([ JSON.stringify({
					"accountIndex" : userValue,
					"password" : pwdValue,
					"realName" : realName,
					"nickname" : nickname,
...
// 						alert("123");
		...
		lastSlide2.onclick = function() {
			var accoutPage1 = document.getElementById("accoutPage1");
			var accoutDetailPage2 = document
					.getElementById("accoutDetailPage2");
			accoutDetailPage2.classList.remove("toshow");
			accoutDetailPage2.classList.add("tohide");
		...
		$("#sendData").on("click" , function(){
			...
			$("#sendData").hide();
			document.getElementById("toLoging").classList.remove("tohide");
			document.getElementById("toLoging").classList.add("toshow");
...
// 										alert(interestResult.success.value);
		...
		$("#toLoging").on("click",function(){
			
			window.location = "<c:url value='/login/page'/>";
								...
								<div class="">
									...
									<div class="" id="accoutPage1">
										<div class="row">
											...
											<div
												style="text-align: center; font-size: 20px; margin-top: 0px; margin-bottom: 15px;">
												<label style="margin-top: 10px; font-weight: bold;">選擇身份:
												</label> <label style="font-weight: bold;"><input
													type="radio" name="accountType" value="user" id="user">&nbsp;使用者註冊</label>
												<label style="font-weight: bold;"><input
													type="radio" name="accountType" value="company"
													id="company">&nbsp;企業註冊</label>
											</div>
											<!-- First -->
											<div class="col-sm-4 col-sm-offset-1">
												<div class="picture-container">
													<div class="picture">
														<img
															src="<c:url value="/images/NoImage/NoImage_Male.png"/>"
															class="picture-src" id="wizardPicturePreview" /> <input
															type="file" id="wizard-picture" accept="image/*"
															name="photo">
													</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label>Email <small>(必填)</small></label> <input
														class="form-control" type="text" name="userName"
														id="UserEmail" placeholder="pepper@Noodle.com"> <span
														id="result"></span><br>
												</div>
												<div class="form-group">
													<label>Password <small>(必填-至少6字且包含英文、數字、特殊字元)</small></label>
													<input class="form-control" type="password" name="userPwd"
														id="userPwd"> <span id="result2"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<button type="button" id="checkMail"
														style="margin-top: 10px; margin-bottom: 10px">驗證信箱</button>
													<label><small id="checkMailInput"></small></label> <input
											...
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group" id=""
													style="border: 1px inset #F0FFFF; height: 100px; overflow: scroll;">
													<c:import var="data" url="/data/PersonalPrivacy.txt"
														charEncoding="UTF-8" />
													<pre>
														<c:out value="${data}" />
													</pre>
...
<!-- 											data-sitekey="***REMOVED-RECAPTCHA-SITE-KEY***"></div> -->
											</div>
											...
											<div
												...
												<div class="pull-right">
													<input type='button'
														...
														name='next' value='Next' id="nextSlide"
										...
										<div class="row">
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													...
													<input class="form-control" type="text" name="nickName"
														id="nickname"> <span id="nickNameresult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													...
													<input class="form-control" type="text" name="realName"
														id="realName"> <span id="realNameresult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>Sex:<small></small></label><br> <input
														type="radio" name="gender" value="男" id="male">男 <input
														type="radio" name="gender" value="女" id="female">女
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>手機:<small>(請輸入10手機號碼。例:09xxxxxxxx)</small></label> <input
														class="form-control" type="text" name="phoneNumber"
														id="phoneNumber"> <span id="phoneNumberresult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>BirthDay:<small>(格式:西元年/月/日
															yyyy/MM/dd)</small></label> <input class="form-control" type="text"
														id="birthday" name="datt" autocomplete="off"> <span
														id="dateresult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>Location:<small>(請選擇所在區域)</small></label><br> <select
											...
											<div
												...
												<div class="pull-right">
													<input type='button'
														class='btn btn-next btn-fill btn-warning btn-wd btn-sm'
														name='next' value='Next' id="nextSlide2"
														style="margin-bottom: 20px; margin-top: 10px" />
												</div>
												<div class="pull-right" style="margin-right: 20%;"
													id="checkAccountStatus2">
													<div style="width: 150px; height: 30px;"></div>
												</div>
												<div class="pull-left">
													<input type='button'
														class='btn btn-previous btn-fill btn-default btn-wd btn-sm'
														name='previous' value='Previous' id='lastSlide2'
														style="margin-bottom: 20px; margin-top: 10px" />
												</div>
											</div>
										</div>
									...
									<div class="tab-pane tohide" id="comDetailPage2">
										<div class="row">
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>企業名稱:<small>(1.不可空白，2.至少兩個字以上)</small></label> <input
														class="form-control" type="text" name="comRealname"
														id="comRealname"> <span id="comRealnameResult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>連絡電話:<small>(請輸入數字。例:09xxxxxxxx)</small></label> <input
														class="form-control" type="text" name="comPhonenumber"
														id="comPhonenumber"> <span id="comPhotoResult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1">
												<div class="form-group">
													<label>地址:<small>(請輸入公司地址)</small></label> <input
														class="form-control" type="text" name="comLocation"
														id="comLocation"> <span id="comLocationResult"></span><br>
												</div>
											</div>
											<div class="col-sm-10 col-sm-offset-1" style="display: none;">
												<div class="form-group">
													<label>企業等級:<small>一般會員</small></label> <input
														class="form-control" type="text" name="comlevel"
														id="comlevel" value="一般會員"> <span
														id="comlevelResult"></span><br>
												</div>
											</div>
											<div
												class="wizard-footer height-wizard col-sm-10 col-sm-offset-1">
												<div class="pull-right">
													<input type='button'
														class='btn btn-next btn-fill btn-warning btn-wd btn-sm'
														name='next' value='Next' id="comNextSlide2"
														style="margin-bottom: 20px; margin-top: 10px" />
												</div>
												<div class="pull-right" style="margin-right: 20%;"
													id="checkComStatus2">
												...
												<div class="pull-left">
													<input type='button'
														class='btn btn-previous btn-fill btn-default btn-wd btn-sm'
														name='previous' value='Previous' id='comlastSlide2'
														style="margin-bottom: 20px; margin-top: 10px" />
												</div>
											</div>
										</div>
									...
									<!-- third -->
									<div class='tohide table table-hover table-bordered'  id="tagPage3">
										<div class="row">

<!-- 											<table class='table  table-bordered ' -->
<!-- 												style='table-layout: fixed; font-size: 10px border-collapse:separate;'> -->
<!-- 												<tr> -->
<!-- 													<td width="50px">興趣:</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="咖哩" -->
<!-- 														id="hobby">咖哩</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="烤肉" -->
<!-- 														id="hobby">烤肉</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="披薩" -->
<!-- 														id="hobby">披薩</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="炸物" -->
<!-- 														id="hobby">炸物</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="漢堡" -->
<!-- 														id="hobby">漢堡</td> -->
<!-- 												</tr> -->
<!-- 												<tr> -->
<!-- 													<td width="50px"></td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="春捲" -->
<!-- 														id="hobby">春捲</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="春捲" -->
<!-- 														id="hobby">春捲</td> -->
<!-- 													<td><input type="checkbox" name="hobby" value="春捲" -->
...
<!-- 											</table> -->
								<div class="col-sm-8 col-sm-offset-2">
											...
											<div class="[ col-xs-6 col-sm-6 ]">
												...
												<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby1" autocomplete="off" value="炸雞" />
													<div class="[ btn-group ]">
														<label for="hobby1"
														...
														<label for="hobby1"
															class="[ btn btn-default active ]"> 炸雞
														</label>
													</div>
												</div>
											    <div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby2" autocomplete="off" value="冰淇淋"/>
													<div class="[ btn-group ]">
														<label for="hobby2"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														</label> <label for="hobby2"
															class="[ btn btn-default active ]">冰淇淋
															 </label>
													</div>
												</div>												<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby3" autocomplete="off" value="炸物"/>
													<div class="[ btn-group ]">
														<label for="hobby3"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														</label> <label for="hobby3"
															class="[ btn btn-default active ]">炸物</label>
													</div>
												</div>												<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby4" autocomplete="off" value="日式"/>
													<div class="[ btn-group ]">
														<label for="hobby4"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														</label> <label for="hobby4"
															class="[ btn btn-default active ]"> 日式</label>
													</div>
												</div>												<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby5" autocomplete="off" value="沙拉"/>
													<div class="[ btn-group ]">
														<label for="hobby5"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														</label> <label for="hobby5"
															class="[ btn btn-default active ]">沙拉</label>
													</div>
												</div>
										    ...
										    <div class="[ col-xs-6 col-sm-6 ]">
												<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby6" autocomplete="off" value="水果" />
													<div class="[ btn-group ]">
														<label for="hobby6"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														...
														<label for="hobby6"
															class="[ btn btn-default active ]"> 水果
														</label>
													</div>
												</div>
										<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby7" autocomplete="off" value="牛排" />
													<div class="[ btn-group ]">
														<label for="hobby7"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														...
														<label for="hobby7"
															class="[ btn btn-default active ]">牛排
														</label>
													</div>
												</div>
																						<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby8" autocomplete="off" value="甜點" />
													<div class="[ btn-group ]">
														<label for="hobby8"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														...
														<label for="hobby8"
															class="[ btn btn-default active ]">甜點
														</label>
													</div>
												</div>
																						<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby9" autocomplete="off" value="火鍋" />
													<div class="[ btn-group ]">
														<label for="hobby9"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														...
														<label for="hobby9"
															class="[ btn btn-default active ]">火鍋
														</label>
													</div>
												</div>
																						<div class="[ form-group ]">
													<input type="checkbox" name="hobby"
														id="hobby10" autocomplete="off" value="羊肉爐" />
													<div class="[ btn-group ]">
														<label for="hobby10"
															class="[ btn btn-warning ]"> <span
															class="[ glyphicon glyphicon-ok ]"></span> <span> </span>
														...
														<label for="hobby10"
															class="[ btn btn-default active ]">羊肉爐
														</label>
													</div>
												</div>
											</div>
											<br> 
											<div
												class="wizard-footer height-wizard col-sm-8 col-sm-offset-1">
												<div class="pull-right">
													<input type='button'
														class='btn btn-next btn-fill btn-warning btn-wd btn-sm'
														name='finish' value='Finish' id='sendData'
														style="margin-bottom: 20px; margin-top: 10px" />
												</div>
												<div class="tohide pull-right" id="toLoging">
													<input type='button'
														class='btn btn-next btn-fill btn-warning btn-wd btn-sm'
														name='finish' value='前往登入'
														style="margin-bottom: 20px; margin-top: 10px" />
												</div>
