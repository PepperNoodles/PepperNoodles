...
<body>
	...
	<div class="container-fluid" >
		<div class="row">
			...
			<!-- 右邊顯示的資料 背景圖片+自動填滿-->
			<div class="col-lg-10 nopadding "style="background-image: url(<c:url value="/images/restaurantCRUD/restaurant-opening-hours.jpg"/>);background-size:cover;">
							...
							<div id="MondayOpen" style="">
								<form:form id="MondayOpenform" method="POST"
									...
									<form:input path="day" type="text" value="" id="day1open"
										style="display:none" />
				<h2 style="color:black"> 時段一:<form:input path="openTime" type="text" id="open1" size="5" class="checkinput"/>to<form:input path="closeTime" type="text" id="close1" class="checkinput" size="5" />
								...
								<br> <br> <input type="button" id="checktime"
									value="鎖定時間" /> <br> <br>
		...
		$('#close1')
				.change(
						function() {
							...
							var timestr2_open1 = $('#close1')[0].value.split(
									":", 2);
							...
							var date1_open2 = moment("20210501", "YYYYMMDD")
									.add(hr2_open1, 'hours').add(min2_open1,
											'minutes');
							var date2_open2 = moment("20210501", "YYYYMMDD")
									.add(hr2_open1, 'hours').add(min2_open1,
											'minutes').add(1, 'minutes');
							var date3_open2 = moment("202105012359",
									"YYYYMMDDHHmm");
			...
			$('#open2').change(function() {
					...
					min1_open2 = timestr1_open2[1];
												...
												var date1 = moment("20210501",
														"YYYYMMDD").add(
														hr1_open2, 'hours')
														.add(min1_open2,
																'minutes');
												var date2 = moment("20210501",
														"YYYYMMDD").add(
														hr1_open2, 'hours')
														.add(min1_open2,
																'minutes').add(
							...
							$('#close2')
									.change(
											function() {
												...
												var timestr2_open2 = $('#close2')[0].value
														.split(":", 2);
												...
												var date1_open3 = moment(
														"20210501", "YYYYMMDD")
														.add(hr2_open2, 'hours')
														.add(min2_open2,
																'minutes');
												var date2_open3 = moment(
														"20210501", "YYYYMMDD")
														.add(hr2_open2, 'hours')
														.add(min2_open2,
																'minutes').add(
																1, 'minutes');
												var date3_open3 = moment(
														"202105012359",
														"YYYYMMDDHHmm");
												...
												$('#open3')
														.change(
																function() {
																	...
																	var timestr1_open3 = $('#open3')[0].value
																			.split(
																					":",
																					2);
												...
												$('#close3')
														.change(
																function() {
																	...
																	var timestr2_open3 = $('#close3')[0].value
																			.split(
																					":",
																					2);
												...
												function() {
													...
													if ($(":selected")[0].value != "X") {
														...
														if ($('#MondayOpenRadio').prop("checked") == true& day1checktime == "true") {
															...
															urls += "<c:url value='Hours/'/>"
																	+ ${restaurantBusinHour.restaurant.restaurantId};
