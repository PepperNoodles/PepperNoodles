...
<body>
    ...
    <main>
        ...
        <!-- Hero Area Start-->
        <div class="slider-area hero-overly" style="background-image:url(<c:url value="/images/hero/frechfries.jpg"/>)">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<c:url value="/images/gallery/location1.jpg"/>" alt="" height="230px" style="overflow: hidden;">
                            </div>
                            <div class="location-details">
                                <p>大安</p>
                                <a href="#" class="location-btn">65 <i class="ti-plus"></i> 地點</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<c:url value="/images/gallery/location2.jpg"/>" alt="" height="230px" style="overflow: hidden;"> 
                            </div>
                            <div class="location-details">
                                <p>信義</p>
                                <a href="#" class="location-btn">60 <i class="ti-plus"></i> 地點</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<c:url value="/images/gallery/location3.jpg"/>" alt="" height="230px" style="overflow: hidden;">
                            </div>
                            <div class="location-details">
                                <p>西門</p>
                                <a href="#" class="location-btn">50 <i class="ti-plus"></i> 地點</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<c:url value="/images/gallery/location4.jpg"/>" alt="" height="230px" style="overflow: hidden;">
                            </div>
                            <div class="location-details">
                                <p>中山</p>
                                <a href="#" class="location-btn">28 <i class="ti-plus"></i> 地點</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<c:url value="/images/gallery/location5.jpg"/>" alt="" height="230px" style="overflow: hidden;">
                            </div>
                            <div class="location-details">
                                <p>士林</p>
                                <a href="#" class="location-btn">78 <i class="ti-plus"></i> 地點</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="<c:url value="/images/gallery/location6.jpg"/>" alt="" height="230px" style="overflow: hidden;">
                            </div>
                            <div class="location-details">
                                <p>內湖</p>
                                <a href="#" class="location-btn">78 <i class="ti-plus"></i> 地點</a>
        ...
        <!-- Services Area Start -->
        <div class="services-area pt-150 pb-150 section-bg" data-background="<c:url value="/images/gallery/section_bg02.jpg"/>" style="opacity: 0.8;">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                            ...
                            <div class="services-cap">
                                <h5><a href="#">1. 選擇喜歡的餐廳種類</a></h5>
                                <p>泰式 越式 美式 日式 中式 韓式 台式 我全都要!!!</p>
                            </div>
                            <!-- Shpape -->
                            <img class="shape1 d-none d-lg-block" src="<c:url value='/images/icon/serices1.png'/>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                            ...
                            <div class="services-cap">
                                <h5><a href="#">2. 選擇喜歡的地點</a></h5>
                                <p>大安 101 北車 中山 西門 美麗華 東區 吃遍全台北!!!</p>
                            </div>
                            <img class="shape2 d-none d-lg-block" src="<c:url value='/images/icon/serices2.png'/>" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="catagori.html">鮭魚之夢</a></h5>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="catagori.html">QQㄋㄟㄋㄟ好喝到咩噗茶</a></h5>
                                <p>這裡沒有賣奶茶，不要肖想了!!!</p>
                                <a href="catagori.html">查看詳情</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="catagori.html">一代一代一代</a></h5>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="catagori.html">優惠券</a></h5>
                                <p>0周年紀念，買十送一，不要拉倒</p>
                                <a href="catagori.html">查看詳情</a>
                            </div>
                        </div>
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder d-flex align-items-center justify-content-center mb-30">
                                        <div class="founder-img">
                                            <img src="<c:url value='/images/testmonial/Homepage_testi.png'/>" alt="" width="250px" height="250px">
                                        </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<c:url value='/images/gallery/home_blog1.png'/>" alt="">
                            </div>
                            <div class="team-caption">
                                <span>美食專欄</span>
                                <h3><a href="blog.html">
                                    本週 3/13、3/14有趣市集一次集結60家知名美食！炸雞界街頭痞子《週末炸雞俱樂部》</a></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<c:url value='/images/gallery/home_blog2.png'/>" alt="">
                            </div>
                            <div class="team-caption">
                                <span>美食專欄</span>
                                <h3><a href="blog.html">
                                    【台北異國餐廳推薦｜七個不同國家】既然不能出國，那就一起用舌尖來環遊世界吧！</a></h3>
                                <p>October 6, 2020by Steve</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="<c:url value='/images/gallery/home_blog3.png'/>" alt="">
                            </div>
                            <div class="team-caption">
                                <span>美食專欄</span>
                                <h3><a href="blog.html">
                                    台北八間必勝景觀餐廳！征服你眼目與味蕾，來一場難以忘懷的高空美食之旅吧！</a></h3>
                                <p>October 6, 2020by Steve</p>
                            </div>
                        </div>
                    </div>
